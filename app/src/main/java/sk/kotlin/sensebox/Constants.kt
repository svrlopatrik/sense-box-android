...
object Constants {
    ...
    const val MODULE_TEMPERATURE_MAX_VALUE = 80f
    const val MODULE_TEMPERATURE_MIN_VALUE = -40f
    const val MODULE_HUMIDITY_MAX_VALUE = 100f
    const val MODULE_HUMIDITY_MIN_VALUE = 0f
